...
public class LoginController {
        ...
        if(email.getText() == null || password.getText() == null || type.getValue()==null){
            ...
            if(null == success){
                ...
                if(type.getValue().toString().equals("Doctor")) {
                    ...
                    doctorController.initService(primaryStage, loginService);
                    ...
                    nurseController.initService(primaryStage, loginService);
                    primaryStage.setScene(new Scene(root));
                    primaryStage.show();
                }
                else{
                    ...
                    patientController.initService(primaryStage, loginService);
                    primaryStage.setScene(new Scene(root));
                    primaryStage.show();
                }
            }
    ...
    public void takeToCreateAccount(MouseEvent mouseEvent) throws IOException {
        ...
        createAccountController.initService(primaryStage, loginService);
        primaryStage.setScene(new Scene(root));
        primaryStage.show();
    }
}
